...
<body style="padding-right: 150px; padding-left: 150px;">
	...
	<table border="1" class="table table-striped">
		...
		$query_mysql = mysqli_query($koneksi, "SELECT id, nama_buku, username, metode, jumlah, total, FORMAT(harga, 0) AS harga FROM pesanan WHERE nama_buku LIKE '%".$judul."%' ")or die(mysqli_error());
		$nomor = 1;
